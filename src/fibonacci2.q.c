...
CODE(3)			
	...
	I(R6+12)=R0;		//Save value right side into variable (static)
	//Free R0
	GT(2);// Jump out of if block 
	// Close if block 
	//////////////////////////////////
L 2:				
	//////////////////////////////////
...
CODE(4)			
	...
	I(R6-0)=R0;		//Save value right side into variable (static)
	//Free R0
	//////////////////////////////////
	// Start procedure call Fibonacci 
	R7=R7-16;			//Reserve params space
	//Get R0
	R0=I(R6-0);		//Load variable 'aux' value
	//Free R0
...
L 8:				
	...
	I(R6-0)=R0;		//Save variable 'resultado1' value
	//Free R0
...
L 9:				
	...
	//Get R0
	R0=I(R7+12);			//Get value parameter 2
	I(R6-0)=R0;		//Save variable 'resultado2' value
	//Free R0
	R7=R7+16;			//Free params space
	// End procedure call Fibonacci 
	//////////////////////////////////
	...
	// Add terms
	//Get R0
	R0=I(R6-0);		//Load value right term
	//Get R1
	R1=I(R6-0);		//Load value left term
	R0=R1+R0;		//Add terms
	//Free R1
	//////////////////////////////////
	// Assignment to variable 'resultado', scope 1
...
L 12:				
	...
	R0=13;				//Return label
	R1=0x11ffa;			//Format int address
	R2=I(0x11fd6);		//Static variable value
...
L 13:				
	...
	R0=I(R7);			//R0 recovered
	R7=R7+4;			//Free space for register R0
	// End of Print variable 'n', scope 0
	//////////////////////////////////
	//////////////////////////////////
	// Start procedure call Fibonacci 
	R7=R7-16;			//Reserve params space
