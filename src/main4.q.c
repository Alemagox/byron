...
L 49:				
	...
	//////////////////////////////////
	//////////////////////////////////
	// Open if block 51. Exit Label is: 53
STAT(18)			
...
L 55:				
	...
	I(R6+12)=R0;		//Save value right side into variable
	//Free R0
	GT(53);// Jump out of if statement 
	// Close if block 
	//////////////////////////////////
L 56:				
L 53:				
	// Close if statement 51
	//////////////////////////////////
...
L 101:				
	...
	//Free R1
	//////////////////////////////////
	// Evaluate while loop -> L:98
	//Free R0
	IF(R0==0) GT(99);	//Jump if 0
	//////////////////////////////////
	// Get variable 'n', scope 0
	R7=R7-4;			//Save space for register R0
	I(R7)=R0;			//R0 saved
...
L 102:				
	...
	// End of Get variable 'n', scope 0
	//////////////////////////////////
	GT(98);			//Evaluate loop again
	// Close while loop -> L:98
	//////////////////////////////////
L 99:				//Exit while loop
	//////////////////////////////////
	// Get variable 'n', scope 0
	R7=R7-4;			//Save space for register R0
	I(R7)=R0;			//R0 saved
